# coding=utf-8
"""
[BETA] The After Sale Service Condition Implied Warranties endpoint
...
class AfterSaleServiceConditionWarranties(BaseApi):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super(AfterSaleServiceConditionWarranties, self).__init__(*args, **kwargs)
        self.endpoint = '/after-sales-service-conditions/warranties'
        self.seller_id = None
